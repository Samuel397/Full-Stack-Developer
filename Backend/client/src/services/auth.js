...
export const USER_TIPE = '&user-type';
...
export const setTipoUsuario = tipo => localStorage.setItem(USER_TIPE,tipo);
export const getTipoUsuario = () => localStorage.getItem(USER_TIPE);
